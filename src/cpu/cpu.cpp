...
#endif
#ifdef MIYOO
		MAPPER_AddHandler(CPU_CycleDecrease,MK_lshift,MMOD1,"cycledown","Dec Cycles"); // SELECT+X
		MAPPER_AddHandler(CPU_CycleIncrease,MK_space,MMOD1,"cycleup"  ,"Inc Cycles"); // SELECT+Y
#else
